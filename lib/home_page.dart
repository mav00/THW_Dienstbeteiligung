...
class _HomePageState extends State<HomePage> {
  ...
  Future<List<Person>> ladePersonenAusYaml() async {
    ...
    if (data is YamlList) {
      return data.map((e) => Person.fromMap(Map<String, dynamic>.from(e))).toList();
    }
    return [];
  }
  ...
  Future<void> speichereEintraegeInYaml() async {
    ...
    await ApiService.saveYamlData('abwesenheiten.yaml', eintraegeMapList);
  }

  Future<void> ladeEintraegeAusYaml() async {
    final data = await ApiService.loadYamlData('abwesenheiten.yaml');
    if (data is YamlList) {
  ...
  Future<void> ladeDiensteAusYaml() async {
    ...
    if (data is YamlList) {
      List<Dienst> geladene = data.map((e) => Dienst.fromMap(Map<String, dynamic>.from(e))).toList();
